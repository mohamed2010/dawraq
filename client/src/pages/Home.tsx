...
function RecordDialog({ open, onOpenChange, form, setForm, onToggleSymptom, onSubmit, busy }: { open: boolean; onOpenChange: (open: boolean) => void; form: RecordFormState; setForm: React.Dispatch<React.SetStateAction<RecordFormState>>; onToggleSymptom: (symptom: string) => void; onSubmit: (event: FormEvent) => void; busy: boolean }) {
  const isEdit = Boolean(form.id);
  return <Dialog open={open} onOpenChange={onOpenChange}>
    <DialogContent className="dialog-content cycle-dialog" dir="rtl">
